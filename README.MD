...
#### INIT
Before using tracklytics, you must initialize it.
```java
...
//OUTPUT   [3+2=5ms] eventName:{key=value}, super attrs: {key=value}
...
buildscript {
  ...
  dependencies {
    classpath 'com.orhanobut.tracklytics:tracklytics-plugin:1.1.16-SNAPSHOT'
  }
}
